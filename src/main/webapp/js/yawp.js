(function($) {
	...
	function yawp(baseArg) {
		...
		function processStatus(statusCode, callback) {
			ajaxOptions.statuses = ajaxOptions.statuses || {};
			ajaxOptions.statuses[statusCode] = callback;
			return this;
		}
